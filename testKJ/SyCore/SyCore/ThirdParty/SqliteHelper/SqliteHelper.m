...
- (BOOL)open{
	...
	NSString *path = [[paths objectAtIndex:0] stringByAppendingFormat:@"/%@", kSyDBFileName];
	if (![[NSFileManager defaultManager] fileExistsAtPath:path]) {
		//Copy from resource
		NSString *resourcedbpath = [[NSBundle mainBundle] pathForResource:kSyDBFileName ofType:nil];
